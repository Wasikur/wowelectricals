...
exports.saveproductdata = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Product Inserted successfully" , status: 201 });
    } catch (error) {
      console.error(error);
...
exports.getproductdata = async (req, res) => {
    try {
        ...
        res.status(200).json({message: "All products get successfully", status: 200, productData});
    } catch (error) {
        console.error(error);
        res.status(500).json({ message: 'Internal server error' });
    }
...
exports.savecategory = async (req, res) => {
    try {
        ...
        res.status(201).json({ message: "Category data Inserted successfully" , status: 201 });
    } catch (error) {
      console.error(error);
      res.status(500).json({ message: 'Internal server error' });
    }
...
exports.getcategory = async (req, res) => {
    try {
        ...
        res.status(200).json({message: "All category get successfully", status: 200, categoryData, categoryCounts});
    } catch (error) {
        console.error(error);
        res.status(500).json({ message: 'Internal server error' });
    }
...
exports.getcategoryproduct = async (req, res) => {
    ...
    try {    
        ...
        res.status(200).json({message: "All category Products get successfully", status: 200, productData});
    } catch (error) {
        console.error(error);
    }
};
...
exports.getproductdetail = async (req, res) => {
    ...
    try {    
        ...
        if(productDetail) {
            res.status(200).json({ message: "Products detail get successfully", status: 200, productDetail, categoryArrayName});
        } else {
            res.status(404).json({ message: 'Product detail not found', status: 404  });
        }
    } catch (error) {
        console.error(error);
    }
...
exports.getsearchdetail = async (req, res) => {
    ...
    try {
        ...
        if(productData) {
            res.status(200).json({ message: "Search detail get successfully", status: 200, productData});
        } else {
...
exports.saveContactform = async (req, res) => {
    ...
    try{          
        ...
        res.status(201).json({ message: "Contact form save successfully", status: 201 });      
    } catch (err) {
        console.log(err);
    }
...
exports.join = async (req, res) => {
    ...
    try{        
        ...
        if(userExist1){
            ...
            await user1.save();
            res.status(201).json({ message: "Email registered successfully" , status: 201 });
        }        
    } catch (err) {
        console.log(err);
    }
